    ...
    <div className="flex min-h-screen w-full flex-col bg-muted/40">
      ...
      <main className="flex-1 space-y-8 p-4 md:p-8">
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Avg. Responses / Survey</CardTitle>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
            ...
            <CardHeader>
                ...
                <CardDescription>An overview of all created surveys.</CardDescription>
            </CardHeader>
            <CardContent>
                <Table>
                <TableHeader>
                ...
                <TableBody>
                    ...
                    <TableRow key={survey.id}>
                        <TableCell className="font-medium">
                            <Link href={`/surveys/${survey.id}/results`} className="hover:underline">
                                {survey.title}
                            </Link>
                        </TableCell>
                        ...
                        {responses.slice(0, 5).map((response) => {
                            ...
                            return (
                                <TableRow key={response.id}>
                                    <TableCell className="font-medium">{survey?.title || 'Unknown Survey'}</TableCell>
